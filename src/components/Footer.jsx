...
export default function Footer() {
  return (
    <footer className="relative bg-gradient-to-br from-charcoal to-slate text-white mt-24">
      <div className="relative z-30 max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        <div>
        ...
        <div>
          ...
          <nav className="flex flex-col gap-2 text-white/80">
            ...
            <Link to="/sermons" className="hover:text-sand">
              Sermons
            </Link>
            <Link to="/events" className="hover:text-sand">
              Events
            </Link>
            <Link to="/partner" className="hover:text-sand">
              Partner
            </Link>
            <Link to="/blog" className="hover:text-sand">
              Blog
            </Link>
        ...
        <div>
          ...
          <ul className="space-y-2 text-white/80 text-sm">
            <li>
              Email:{" "}
              <a href="mailto:donate@4theone.org" className="underline">
                donate@4theone.org
              </a>
            </li>
            <li>
      ...
      <div className="relative z-30 border-t border-white/10">
        <div className="max-w-6xl mx-auto px-6 py-6 text-center text-white/60 text-sm">
          © {new Date().getFullYear()} 4theOne International. All rights
          reserved.
        </div>
      </div>
    </footer>
